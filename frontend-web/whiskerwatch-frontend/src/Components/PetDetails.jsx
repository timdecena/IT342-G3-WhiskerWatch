  ...
  if (!pet) {
    return (
      <div className="pet-details-error">
        Pet not found or failed to load.
      </div>
    );
  }
          ...
          <div className="pet-info-container">
            ...
            <div className="pet-details-grid">
              ...
              <div className="detail-item">
                ...
                <span
                  className={`detail-value status-${pet.status.toLowerCase()}`}
                >
                  {pet.status}
                </span>
              </div>
      ...
      <div className="faq-section">
        ...
        <div className="faq-item">
          ...
          <p className="faq-answer">
            After you fill out the adoption form, our team will review your
            application within 24–48 hours. You’ll be contacted for a short
            interview before the adoption is finalized.
          </p>
        </div>
        <div className="faq-item">
          ...
          <p className="faq-answer">
            Yes, all our pets are vaccinated, dewormed, and neutered before they
        ...
        <div className="faq-item">
          ...
          <p className="faq-answer">
            Absolutely. We offer a 14-day return period and provide support to
            help you transition your pet back safely.
          </p>
        </div>
      </div>
    </div>
